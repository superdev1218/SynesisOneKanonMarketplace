    ...
    <Box className={classes.detailContent}>
      <Box className={classes.backIcon}>
        <Button className={classes.backBtn}>
          <LeftArrow /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <Typography className={classes.backTitle} onClick={() => navigate('/marketplace')}>
            {' '}
            Get back
          </Typography>
        </Button>
                ...
                <Box className={classes.listItem}>
                  ...
                  <Grid item className={classes.card3}>
                    <Box sx={{ display: 'block' }}>
                      <Typography sx={{ display: 'flex', justifyContent: 'center' }} className={classes.title2}>
                        {' '}
                        Staked{' '}
                      </Typography>
                  ...
                  <AccordionDetails className={classes.accordionDetails}>
                    <Grid container>
                      {metadata.metadataExternal.attributes.map((element, index) => (
                        <Grid
                          item
                          xl={(metadata.metadataExternal.attributes.length == 1 ? 1 : 0 || index == 0 ? 1 : 0) ? 12 : 4}
                        ...
                        >
                          <Box className={classes.propertiesDiv} key={index}>
                            ...
                            <Typography onClick={() => copyValue(element.value)} className={classes.detailText}>
                              {' '}
                              {element.value}{' '}
                            </Typography>
                          </Box>
