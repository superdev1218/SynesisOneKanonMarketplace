...
export const Types = {
    ...
    SETSTAKEPROGRAM: '@setStakeProgram',
    SETSTAKEPROVIODER: '@setStakeProvider',
}
...
export default function reducer(
    ...
    switch (type) {
        ...
        case Types.SETSTAKEPROGRAM:
            return { ...state, stakeProgram: payload }
        case Types.SETSTAKEPROVIODER:
            return { ...state, stakeProvider: payload }
...
export const setStakeProvider = (data) => ({ type: Types.SETSTAKEPROVIODER, payload: data });

export const setStakeProgram = (data) => ({ type: Types.SETSTAKEPROGRAM, payload: data });