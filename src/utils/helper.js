...
const {
  ...
  REACT_APP_PUBLISHDURATION,
  REACT_APP_airdrop_pg_size,
  REACT_APP_mywallet_pg_size,
  REACT_APP_marketplace_pg_size,
  REACT_APP_CALLTIME,
...
export const getCollections = async (PgFrom) => {
  try {
    let res = await axios.post(`${REACT_APP_SERVER_URL}/getnftsoverallcollections`, {
      pg_from: PgFrom,
      pg_size: MywalletPgSize
    });
...
export const getAddressCollections = async (addresses, season) => {
  try {
    let res = await axios.post(`${REACT_APP_SERVER_URL}/getmetadatabymintaddressesandseasonnumber`, {
      mint_addresses: addresses,
...
export const getMetadataByMintaddresses = async (season, addresses) => {
  try {
    let res = await axios.post(`${REACT_APP_SERVER_URL}/getmetadatabymintaddresses`, {
      mint_addresses: addresses,
      season_number: season
    });
    return res.data.result;
...
export const getthumbnailbymintaddresses = async (season, pg_from, pg_size, addresses) => {
  try {
    let res = await axios.post(`${REACT_APP_SERVER_URL}/getthumbnailbymintaddresses`, {
      mint_addresses: addresses,
      season_number: season,
      pg_from: pg_from,
      pg_size: pg_size
...
export const getreservednftproofbymintaddressandwallet = async (wallet, nft_mint_address) => {
  try {
    let res = await axios.post(`${REACT_APP_SERVER_URL}/getreservednftproofbymintaddressandwallet`, {
      wallet: wallet,
...
export const findAssociatedTokenAddress = async (walletAddress, tokenMintAddress) => {
  return (
